...
const CreateAppointment: React.FC = () => {
  ...
  const handleToggleDatePicker = useCallback(() => {
    // se passar uma funcao, ela recebe o valor antigo do estado, aí nao precisa colocar nas dependencias o showDatePicker executando menos x essa funcao
          ...
          <Section>
            ...
            <SectionContent>
              {morningAvailability.map(({ hourFormatted, available, hour }) => (
                <Hour enabled={available} available={available} selected={selectedHour === hour} key={hourFormatted} onPress={() => handleSelectHour(hour)}>
